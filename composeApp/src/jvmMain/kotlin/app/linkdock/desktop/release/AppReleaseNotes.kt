...
object AppReleaseNotes {
    private val notes = listOf(
        ReleaseNoteEntry(
            ...
            items = listOf(
                "항목이 없을 때와 선택이 필요한 때의 화면 표시를 더 자연스럽게 정리했습니다.",
                "받을 항목을 아직 고르지 않은 경우 안내 문구가 더 알맞게 보이도록 개선했습니다.",
                "항목 선택 전과 선택 후의 상태 변화가 더 쉽게 보이도록 다듬었습니다."
            )
        ),
        ReleaseNoteEntry(
            version = "1.10.8",
            title = "내부 상태 판단과 다운로드 확인 흐름을 더 안정적으로 정리했습니다.",
            items = listOf(
                "여러 작업이 겹칠 때 상태 판단이 더 일관되게 이어지도록 내부 흐름을 정리했습니다.",
                "작업 중 상태를 판단하는 기준을 다듬어 전체 동작 안정성을 개선했습니다.",
                "다운로드 항목을 확인하는 과정에서 로그인 실패나 접근 문제를 더 분명하게 안내하도록 개선했습니다.",
                "다운로드할 항목을 제대로 확인하지 못한 경우에는 잘못 진행되지 않도록 보완했습니다."
            )
        ),
        ReleaseNoteEntry(
            version = "1.10.7",
        ...
        ReleaseNoteEntry(
            ...
            items = listOf(
                "다운로드 준비 중에는 설치 확인이나 업데이트 동작이 함께 겹쳐 실행되지 않도록 개선했습니다.",
                "여러 작업이 동시에 진행되며 상태가 헷갈리던 흐름을 줄여 전체 동작이 더 안정적으로 이어지도록 정리했습니다.",
                "준비 중, 확인 중, 설치 중 상태 표시가 실제 동작과 더 자연스럽게 맞도록 보완했습니다."
            )
        ),
        ReleaseNoteEntry(
            version = "1.10.4",
